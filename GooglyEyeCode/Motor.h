/*
  ...
  Abstraction of the basic motor functions - keeping it as simple as possible.alignas
...
private:
  ...
  {
    writeToPins(
        bitRead(stepSequence[stepIndex], 0),
        bitRead(stepSequence[stepIndex], 1),
        bitRead(stepSequence[stepIndex], 2),
        bitRead(stepSequence[stepIndex], 3));
  }

  void writeToPins(bool p1, bool p2, bool p3, bool p4)
  {
    digitalWrite(_pin1, p1);
    digitalWrite(_pin2, p2);
    digitalWrite(_pin3, p3);
    digitalWrite(_pin4, p4);
  }
};
