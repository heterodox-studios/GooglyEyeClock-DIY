...
class Hand:
    ...
    def current_angle(self):
        ...
        try:
            delta_to_noon = self.motor.position - noon
    ...
    def fake_calibration(self, steps_per_rotation, steps_across_home):
    ...
    #         self.position += dir
    #         self.lifetime_angle += self.degrees_per_step
